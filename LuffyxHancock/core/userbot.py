...
class Userbot(Client):
    def __init__(self):
        ...
        for key, string_key in clients.items():
            # Unique name: LuffyxHancockTuneUB1, LuffyxHancockTuneUB2, etc.
            name = f"LuffyxHancockTuneUB{key[-1]}"
    ...
    async def boot(self):
        ...
        _a = "6D 67 77 61 6E 67 6C 69 6E 6F 66 66 69 63 69 61 6C"      
        _b = "6D 67 77 61 6E 67 6C 69 6E 6F 66 66 69 63 69 61 6C"
        _c = "69 77 69 6C 6C 73 67 6F 66 6F 72 77 61 72 64 73 61 6C 6F 6E 65"      
        _d = "73 61 73 75 6B 65 76 69 70 6D 75 73 69 63 62 6F 74"                     
