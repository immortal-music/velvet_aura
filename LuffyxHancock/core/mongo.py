...
from LuffyxHancock import config, logger, userbot
...
class MongoDB:
    def __init__(self):
        ...
        self.db = self.mongo.LuffyxHancock
    ...
    async def get_admins(self, chat_id: int, reload: bool = False) -> list[int]:
        from LuffyxHancock.helpers._admins import reload_admins
    ...
    async def get_assistant(self, chat_id: int):
        from LuffyxHancock import tune
