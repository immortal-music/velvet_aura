...
from LuffyxHancock import tune, app, config, db, lang, queue, tg, yt
from LuffyxHancock.helpers import buttons, utils
from LuffyxHancock.helpers._play import checkUB
import asyncio
import logging
...
async def play_hndlr(
    ...
    if force:
        ...
        if await db.get_call(chat_id):
            ...
            try:
                from LuffyxHancock import preload
    ...
    try:
        ...
        if "bot" in error_msg.lower() or "sign in" in error_msg.lower():
            await safe_edit(
                ...
                "Solution:\n"
                "• Update YouTube cookies in `LuffyxHancock/cookies/` folder\n"
