...
class Config:
    def __init__(self):
        ...
        # Support Links
        self.SUPPORT_CHANNEL: str = getenv("SUPPORT_CHANNEL", "https://t.me/mgwanglinofficial")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/iwillsgoforwardsalone")
